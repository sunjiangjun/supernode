...
func (e *Bnb) TokenURI(host string, key string, contractAddress string, tokenId string, eip int64) (string, error) {
...
func (e *Bnb) BalanceOf(host string, key string, contractAddress string, address string, tokenId string, eip int64) (string, error) {
	if len(key) > 1 {
		host = fmt.Sprintf("%v/%v", host, key)
	}
...
func (e *Bnb) OwnerOf(host string, key string, contractAddress string, tokenId string, eip int64) (string, error) {
	if len(key) > 1 {
		host = fmt.Sprintf("%v/%v", host, key)
	}
...
func (e *Bnb) TotalSupply(host string, key string, contractAddress string, eip int64) (string, error) {
	if len(key) > 1 {
		host = fmt.Sprintf("%v/%v", host, key)
	}
...
func (e *Bnb) GetToken721(host string, key string, contractAddress string, userAddress string) (map[string]interface{}, error) {
...
func (e *Bnb) GetToken1155(host string, key string, contractAddress string, userAddress string) (map[string]interface{}, error) {
	mp := make(map[string]interface{}, 2)
	//if len(key) > 1 {
	//	host = fmt.Sprintf("%v/%v", host, key)
	//}
...
func (e *Bnb) Subscribe(host string, token string) (string, error) {
	if len(token) > 1 {
...
func (e *Bnb) GetToken20(host string, key string, contractAddress string, userAddress string) (map[string]interface{}, error) {
